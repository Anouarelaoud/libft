...
#    Updated: 2018/10/17 21:01:16 by aait-el-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =  ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
	...
	ft_tolower.c ft_strnew.c ft_strdel.c ft_strclr.c \
	ft_striter.c ft_striteri.c ft_strmap.c ft_strmapi.c ft_strequ.c \
	ft_strnequ.c ft_strsub.c ft_strjoin.c ft_strtrim.c ft_strsplit.c \
	ft_itoa.c ft_putchar.c ft_putstr.c ft_putendl.c ft_putnbr.c \
	ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c \
	ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c \
	ft_lstmap.c ft_abs.c ft_nbr_words.c ft_swap.c ft_strlowcase.c \
	ft_strcapitalize.c ft_word_size.c

OUT =   ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o \
	ft_memmove.o ft_memchr.o ft_memcmp.o ft_memalloc.o \
	ft_memdel.o ft_strlen.o \
	...
	ft_tolower.o ft_strnew.o ft_strdel.o ft_strclr.o \
	...
	ft_lstmap.o ft_abs.o ft_nbr_words.o ft_swap.o ft_strlowcase.o \
	ft_strcapitalize.o ft_word_size.o
